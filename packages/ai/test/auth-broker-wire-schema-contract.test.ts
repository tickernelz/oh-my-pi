...
const validSamples: Record<SchemaName, unknown> = {
	...
	credentialBlockDeleteRequestSchema: BLOCK,
	credentialBlockDeleteResponseSchema: { deleted: true },
...
describe("auth-broker public wire schemas", () => {
	test("exports all 33 real callable ArkType values with canonical behavior", () => {
